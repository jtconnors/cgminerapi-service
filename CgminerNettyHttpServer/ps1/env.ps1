...
#
Set-Variable -Name PROJECT -Value CgminerNettyHttpServer
Set-Variable -Name VERSION -Value "1.0-JDK8"
Set-Variable -Name MAINCLASS -Value com.jtconnors.cgminerapi.netty.CgminerNettyHttpServer
...
Set-Variable -Name EXTERNAL_CLASSPATH -Value @(
    ...
    "$REPO\com\jtconnors\com.jtconnors.cgminerapi\4.10.0.1-JDK8\com.jtconnors.cgminerapi-4.10.0-JDK8.jar",
